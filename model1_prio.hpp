...
namespace model1_prio_model_namespace {
...
class model1_prio_model final : public model_base_crtp<model1_prio_model> {
 ...
 public:
  ...
  inline std::string model_name() const final { return "model1_prio_model"; }
  ...
  model1_prio_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "model1_prio_model_namespace::model1_prio_model";
    ...
    try {
      ...
      Gs = std::vector<double>(N, std::numeric_limits<double>::quiet_NaN());
      
      
      current_statement__ = 10;
      Gs = context__.vals_r("Gs");
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "model1_prio_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "model1_prio_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
      ...
      for (int k = 1; k <= N; ++k) {
        ...
        stan::model::assign(y_sim,
          stan::math::normal_rng(
            ((beta *
               stan::model::rvalue(Gs, "Gs", stan::model::index_uni(N))) +
...
using stan_model = model1_prio_model_namespace::model1_prio_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return model1_prio_model_namespace::profiles__;
}
